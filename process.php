...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        try {
            ...
            $mail->AddAddress('YOUR GMAIL ADDRESS HERE');
            $mail->Send();
			$mail2->IsSMTP();
            $mail2->SMTPDebug = 0;
            $mail2->SMTPAuth = true;
            ...
            $mail2->SetFrom('YOUR WEBSITE EMAIL HERE', 'NAME OF WEBSITE');
            $mail2->Subject = "Contact Form Submission";
            $mail2->Body = "Thank you for contacting us, we will reply within 48 hours.";
